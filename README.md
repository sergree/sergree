...
Меня зовут Сергей. Я занимаюсь разработкой программного обеспечения, стремясь своим трудом принести пользу людям. Основными направлениями моей деятельности являются [бэкенд-разработка][backend dev], [машинное обучение][ML] и [музыкальное творчество][music production].
...
[backend dev]: https://en.wikipedia.org/wiki/Frontend_and_backend
