...
Меня зовут Сергей. Я <!--дипломированный инженер [машинного обучения][ML], -->занимаюсь созданием программных решений, стремясь своим трудом принести пользу людям. Основными направлениями моей деятельности являются [бэкенд-разработка][backend dev] и практическое применение технологий [искусственного интеллекта][AI].
...
- Ведущий бэкенд-разработчик [дивизиона развития технологий искусственного интеллекта T1][T1]
